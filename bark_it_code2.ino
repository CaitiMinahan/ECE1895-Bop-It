...
const int paw_it_sound[] = {2, NOTE_B0, 2, NOTE_C1};  // array format: # notes, note to play 
const int walk_it_sound[] = {2, NOTE_CS1, 2, NOTE_D1};
const int speak_it_sound[] = {2, NOTE_DS1, 2, NOTE_E1};
    ...
    while(repeat != 0){
      ...
      // switch on the 3 commands
        ...
        case 1: 
          //lcd.clear(); 
          //lcd.print("Paw-It!"); 
          for (int thisNote = 0; thisNote < paw_it_sound[0] * 2; thisNote = thisNote + 2) {
              // calculates the duration of each note
              divider = paw_it_sound[thisNote + 1];
              if (divider > 0) {
            ...
            tone(speaker, paw_it_sound[thisNote], (1000 / paw_it_sound[thisNote + 1]));     // Play the single note
            delay((1000 / paw_it_sound[thisNote + 1]) * 1.30);                          // Delay for the specified time
        ...
        case 2: 
          //lcd.clear(); 
          //lcd.print("Walk-It!"); 
          for (int thisNote = 0; thisNote < walk_it_sound[0] * 2; thisNote = thisNote + 2) {
              // calculates the duration of each note
              divider = walk_it_sound[thisNote + 1];
              if (divider > 0) {
                // regular note, just proceed
                noteDuration = (wholenote) / divider;
              } else if (divider < 0) {
            ...
            tone(speaker, walk_it_sound[thisNote], (1000 / walk_it_sound[thisNote + 1]));     // Play the single note
            delay((1000 / walk_it_sound[thisNote + 1]) * 1.30);                          // Delay for the specified time
            noTone(speaker);                                                 // Silence the note that was playing
          }
        ...
        case 3:
          //lcd.clear(); 
          //lcd.print("Speak-It!"); 
          for (int thisNote = 0; thisNote < speak_it_sound[0] * 2; thisNote = thisNote + 2) {
              // calculates the duration of each note
              divider = speak_it_sound[thisNote + 1];
              if (divider > 0) {
                // regular note, just proceed
                noteDuration = (wholenote) / divider;
              } else if (divider < 0) {
            ...
            tone(speaker, speak_it_sound[thisNote], (1000 / speak_it_sound[thisNote + 1]));     // Play the single note
            delay((1000 / speak_it_sound[thisNote + 1]) * 1.30);                          // Delay for the specified time
            noTone(speaker);                                                 // Silence the note that was playing
          }
